...
The entry is made with an accounting date equal to the accounting date
of the freight forwarder’s invoice. Use the same accounting date also in
...
La scrittura di storno viene fatta in data contabile uguale alla data
contabile della fattura spedizioniere. Utilizzare la stessa data
contabile anche nella bolletta doganale.
