...
class EFatturaOut:
    def get_template_values(self):  # noqa: C901
        ...
        if self.partner_id.commercial_partner_id.is_pa:
            # check value code
            code = self.partner_id.ipa_code or (
                self.partner_id.commercial_partner_id
                and self.partner_id.commercial_partner_id.ipa_code
            )
        else:
            code = self.partner_id.codice_destinatario or (
                self.partner_id.commercial_partner_id
                and self.partner_id.commercial_partner_id.codice_destinatario
            )
